...
router.post("/backpack", firebaseAuthMiddleware_1.default, backpackController_1.default.createBackPack);
router.put("/backpack/:id", firebaseAuthMiddleware_1.default, backpackController_1.default.updateBackPack);
router.delete("/backpack/:id", firebaseAuthMiddleware_1.default, backpackController_1.default.deleteBackPack);
// Category routes
